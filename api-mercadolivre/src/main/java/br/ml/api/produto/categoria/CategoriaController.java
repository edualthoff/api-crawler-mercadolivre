...
public class CategoriaController {
	...
	public Categoria atualizar(@PathVariable(value = "idCategoria") Long idCategoria, @RequestBody @Valid Categoria categoria) {
	...
	public Categoria buscarPorId(@PathVariable(value = "idCategoria") Long idCategoria) {
		return catService.buscarPorId(idCategoria);
	}
	
	@GetMapping(path = "/")
	public Iterator<Categoria> buscarAll(@RequestParam(value = "ids", required = false) Long[] ids) {
		if(ids != null) {
	...
	public void excluirId(@PathVariable(value = "idCategoria") Long idCategoria) {
