...
-- object: public.tb_settings | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_settings CASCADE;
CREATE TABLE public.tb_settings (
	tenant_id text NOT NULL,
	enviar_email_vazio boolean NOT NULL,
	CONSTRAINT tb_settings_pk PRIMARY KEY (tenant_id)
